...
// @generated from protobuf file "rustplus.proto" (package "rustplus", syntax proto3)
import type {
    BinaryReadOptions,
    BinaryWriteOptions,
    IBinaryReader,
...
class Vector3$Type extends MessageType<Vector3> {
    ...
    internalBinaryWrite(
        ...
        if (message.y !== 0) writer.tag(2, WireType.Bit32).float(message.y);
        /* float z = 3; */
        if (message.z !== 0) writer.tag(3, WireType.Bit32).float(message.z);
        const u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(
                this.typeName,
...
class Vector4$Type extends MessageType<Vector4> {
    ...
    internalBinaryWrite(
        ...
        if (message.z !== 0) writer.tag(3, WireType.Bit32).float(message.z);
        /* float w = 4; */
        if (message.w !== 0) writer.tag(4, WireType.Bit32).float(message.w);
        const u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(
                this.typeName,
...
class Color$Type extends MessageType<Color> {
    ...
    internalBinaryWrite(
        ...
        /* float r = 1; */
        if (message.r !== 0) writer.tag(1, WireType.Bit32).float(message.r);
        /* float g = 2; */
        if (message.g !== 0) writer.tag(2, WireType.Bit32).float(message.g);
        /* float b = 3; */
        if (message.b !== 0) writer.tag(3, WireType.Bit32).float(message.b);
        /* float a = 4; */
        if (message.a !== 0) writer.tag(4, WireType.Bit32).float(message.a);
        const u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(
                this.typeName,
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional rustplus.Vector3 origin */ 1:
                    message.origin = Vector3.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.origin
                ...
                case /* optional rustplus.Vector3 direction */ 2:
                    message.direction = Vector3.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.direction
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional rustplus.ClanInfo clanInfo */ 4:
                    message.clanInfo = ClanInfo.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.clanInfo
...
class ClanInfo$Type extends MessageType<ClanInfo> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.ClanInfo.Role roles */ 10:
                    message.roles.push(
                        ClanInfo_Role.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated rustplus.ClanInfo.Member members */ 11:
                    message.members.push(
                        ClanInfo_Member.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated rustplus.ClanInfo.Invite invites */ 12:
                    message.invites.push(
                        ClanInfo_Invite.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.roles.length; i++)
            ClanInfo_Role.internalBinaryWrite(
                message.roles[i],
        ...
        for (let i = 0; i < message.members.length; i++)
            ClanInfo_Member.internalBinaryWrite(
                message.members[i],
        ...
        for (let i = 0; i < message.invites.length; i++)
            ClanInfo_Invite.internalBinaryWrite(
                message.invites[i],
...
class ClanLog$Type extends MessageType<ClanLog> {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.ClanLog.Entry logEntries */ 2:
                    message.logEntries.push(
                        ClanLog_Entry.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.logEntries.length; i++)
            ClanLog_Entry.internalBinaryWrite(
...
class ClanInvitations$Type extends MessageType<ClanInvitations> {
            ...
            switch (fieldNo) {
                case /* repeated rustplus.ClanInvitations.Invitation invitations */ 1:
                    message.invitations.push(
                        ClanInvitations_Invitation.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.invitations.length; i++)
            ClanInvitations_Invitation.internalBinaryWrite(
                message.invitations[i],
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join();
        const u = options.writeUnknownFields;
...
class ClanInvitations_Invitation$Type extends MessageType<ClanInvitations_Invitation> {
    ...
    create(
        value?: PartialMessage<ClanInvitations_Invitation>
        ...
        message.timestamp = "0";
        if (value !== undefined)
            reflectionMergePartial<ClanInvitations_Invitation>(
                this,
                message,
                value
            );
    ...
    internalBinaryRead(
        ...
        length: number,
        options: BinaryReadOptions,
        target?: ClanInvitations_Invitation
    ): ClanInvitations_Invitation {
        const message = target ?? this.create(),
            end = reader.pos + length;
        while (reader.pos < end) {
    ...
    internalBinaryWrite(
        message: ClanInvitations_Invitation,
        writer: IBinaryWriter,
        options: BinaryWriteOptions
    ): IBinaryWriter {
        /* int64 clanId = 1; */
...
class AppRequest$Type extends MessageType<AppRequest> {
    constructor() {
        super("rustplus.AppRequest", [
            ...
            {
                no: 30,
                name: "cameraSubscribe",
                kind: "message",
                T: () => AppCameraSubscribe
            },
            {
                no: 31,
                name: "cameraUnsubscribe",
                kind: "message",
                T: () => AppEmpty
            },
            {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional rustplus.AppEmpty getInfo */ 8:
                    message.getInfo = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getInfo
                ...
                case /* optional rustplus.AppEmpty getTime */ 9:
                    message.getTime = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getTime
                ...
                case /* optional rustplus.AppEmpty getMap */ 10:
                    message.getMap = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getMap
                ...
                case /* optional rustplus.AppEmpty getTeamInfo */ 11:
                    message.getTeamInfo = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getTeamInfo
                ...
                case /* optional rustplus.AppEmpty getTeamChat */ 12:
                    message.getTeamChat = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getTeamChat
                ...
                case /* optional rustplus.AppSendMessage sendTeamMessage */ 13:
                    message.sendTeamMessage = AppSendMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.sendTeamMessage
                    );
                    break;
                case /* optional rustplus.AppEmpty getEntityInfo */ 14:
                    message.getEntityInfo = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                ...
                case /* optional rustplus.AppSetEntityValue setEntityValue */ 15:
                    message.setEntityValue =
                        AppSetEntityValue.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.setEntityValue
                ...
                case /* optional rustplus.AppEmpty checkSubscription */ 16:
                    message.checkSubscription = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.checkSubscription
                    );
                    break;
                case /* optional rustplus.AppFlag setSubscription */ 17:
                    message.setSubscription = AppFlag.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.setSubscription
                    );
                    break;
                case /* optional rustplus.AppEmpty getMapMarkers */ 18:
                    message.getMapMarkers = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getMapMarkers
                    );
                    break;
                case /* optional rustplus.AppPromoteToLeader promoteToLeader */ 20:
                    message.promoteToLeader =
                        AppPromoteToLeader.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.promoteToLeader
                ...
                case /* optional rustplus.AppEmpty getClanInfo */ 21:
                    message.getClanInfo = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getClanInfo
                ...
                case /* optional rustplus.AppSendMessage setClanMotd */ 22:
                    message.setClanMotd = AppSendMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.setClanMotd
                ...
                case /* optional rustplus.AppEmpty getClanChat */ 23:
                    message.getClanChat = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getClanChat
                ...
                case /* optional rustplus.AppSendMessage sendClanMessage */ 24:
                    message.sendClanMessage = AppSendMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.sendClanMessage
                    );
                    break;
                case /* optional rustplus.AppGetNexusAuth getNexusAuth */ 25:
                    message.getNexusAuth = AppGetNexusAuth.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.getNexusAuth
                    );
                    break;
                case /* optional rustplus.AppCameraSubscribe cameraSubscribe */ 30:
                    message.cameraSubscribe =
                        AppCameraSubscribe.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.cameraSubscribe
                ...
                case /* optional rustplus.AppEmpty cameraUnsubscribe */ 31:
                    message.cameraUnsubscribe = AppEmpty.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.cameraUnsubscribe
                    );
                    break;
                case /* optional rustplus.AppCameraInput cameraInput */ 32:
                    message.cameraInput = AppCameraInput.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.cameraInput
    ...
    internalBinaryWrite(
        ...
        if (message.sendTeamMessage)
            AppSendMessage.internalBinaryWrite(
                message.sendTeamMessage,
        ...
        if (message.setEntityValue)
            AppSetEntityValue.internalBinaryWrite(
                message.setEntityValue,
        ...
        if (message.promoteToLeader)
            AppPromoteToLeader.internalBinaryWrite(
                message.promoteToLeader,
        ...
        if (message.getNexusAuth)
            AppGetNexusAuth.internalBinaryWrite(
                message.getNexusAuth,
        ...
        if (message.cameraSubscribe)
            AppCameraSubscribe.internalBinaryWrite(
                message.cameraSubscribe,
        ...
        if (message.cameraInput)
            AppCameraInput.internalBinaryWrite(
                message.cameraInput,
...
class AppMessage$Type extends MessageType<AppMessage> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional rustplus.AppResponse response */ 1:
                    message.response = AppResponse.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.response
                ...
                case /* optional rustplus.AppBroadcast broadcast */ 2:
                    message.broadcast = AppBroadcast.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.broadcast
    ...
    internalBinaryWrite(
        ...
        if (message.response)
            AppResponse.internalBinaryWrite(
                message.response,
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.broadcast)
            AppBroadcast.internalBinaryWrite(
                message.broadcast,
                writer.tag(2, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppResponse$Type extends MessageType<AppResponse> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional rustplus.AppSuccess success */ 4:
                    message.success = AppSuccess.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.success
                ...
                case /* optional rustplus.AppError error */ 5:
                    message.error = AppError.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.error
                ...
                case /* optional rustplus.AppInfo info */ 6:
                    message.info = AppInfo.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.info
                ...
                case /* optional rustplus.AppTime time */ 7:
                    message.time = AppTime.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.time
                ...
                case /* optional rustplus.AppMap map */ 8:
                    message.map = AppMap.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.map
                ...
                case /* optional rustplus.AppTeamInfo teamInfo */ 9:
                    message.teamInfo = AppTeamInfo.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.teamInfo
                ...
                case /* optional rustplus.AppTeamChat teamChat */ 10:
                    message.teamChat = AppTeamChat.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.teamChat
                ...
                case /* optional rustplus.AppEntityInfo entityInfo */ 11:
                    message.entityInfo = AppEntityInfo.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.entityInfo
                ...
                case /* optional rustplus.AppFlag flag */ 12:
                    message.flag = AppFlag.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.flag
                ...
                case /* optional rustplus.AppMapMarkers mapMarkers */ 13:
                    message.mapMarkers = AppMapMarkers.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.mapMarkers
                ...
                case /* optional rustplus.AppClanInfo clanInfo */ 15:
                    message.clanInfo = AppClanInfo.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.clanInfo
                ...
                case /* optional rustplus.AppClanChat clanChat */ 16:
                    message.clanChat = AppClanChat.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.clanChat
                ...
                case /* optional rustplus.AppNexusAuth nexusAuth */ 17:
                    message.nexusAuth = AppNexusAuth.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.nexusAuth
                ...
                case /* optional rustplus.AppCameraInfo cameraSubscribeInfo */ 20:
                    message.cameraSubscribeInfo =
                        AppCameraInfo.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            message.cameraSubscribeInfo
    ...
    internalBinaryWrite(
        ...
        if (message.success)
            AppSuccess.internalBinaryWrite(
                message.success,
                writer.tag(4, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.teamInfo)
            AppTeamInfo.internalBinaryWrite(
                message.teamInfo,
                writer.tag(9, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.teamChat)
            AppTeamChat.internalBinaryWrite(
                message.teamChat,
                writer.tag(10, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.entityInfo)
            AppEntityInfo.internalBinaryWrite(
                message.entityInfo,
                writer.tag(11, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.mapMarkers)
            AppMapMarkers.internalBinaryWrite(
                message.mapMarkers,
                writer.tag(13, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.clanInfo)
            AppClanInfo.internalBinaryWrite(
                message.clanInfo,
                writer.tag(15, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.clanChat)
            AppClanChat.internalBinaryWrite(
                message.clanChat,
                writer.tag(16, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.nexusAuth)
            AppNexusAuth.internalBinaryWrite(
                message.nexusAuth,
                writer.tag(17, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.cameraSubscribeInfo)
            AppCameraInfo.internalBinaryWrite(
                message.cameraSubscribeInfo,
                writer.tag(20, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppBroadcast$Type extends MessageType<AppBroadcast> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional rustplus.AppTeamChanged teamChanged */ 4:
                    message.teamChanged = AppTeamChanged.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.teamChanged
                ...
                case /* optional rustplus.AppNewTeamMessage teamMessage */ 5:
                    message.teamMessage = AppNewTeamMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.teamMessage
                ...
                case /* optional rustplus.AppEntityChanged entityChanged */ 6:
                    message.entityChanged = AppEntityChanged.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                ...
                case /* optional rustplus.AppClanChanged clanChanged */ 7:
                    message.clanChanged = AppClanChanged.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.clanChanged
                ...
                case /* optional rustplus.AppNewClanMessage clanMessage */ 8:
                    message.clanMessage = AppNewClanMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.clanMessage
                ...
                case /* optional rustplus.AppCameraRays cameraRays */ 10:
                    message.cameraRays = AppCameraRays.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.cameraRays
    ...
    internalBinaryWrite(
        ...
        if (message.teamChanged)
            AppTeamChanged.internalBinaryWrite(
                message.teamChanged,
                writer.tag(4, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.teamMessage)
            AppNewTeamMessage.internalBinaryWrite(
                message.teamMessage,
                writer.tag(5, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.entityChanged)
            AppEntityChanged.internalBinaryWrite(
                message.entityChanged,
                writer.tag(6, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.clanChanged)
            AppClanChanged.internalBinaryWrite(
                message.clanChanged,
                writer.tag(7, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.clanMessage)
            AppNewClanMessage.internalBinaryWrite(
                message.clanMessage,
                writer.tag(8, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        if (message.cameraRays)
            AppCameraRays.internalBinaryWrite(
                message.cameraRays,
                writer.tag(10, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppInfo$Type extends MessageType<AppInfo> {
    ...
    internalBinaryWrite(
        ...
        if (message.camerasEnabled !== false)
...
class AppMap$Type extends MessageType<AppMap> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.AppMap.Monument monuments */ 5:
                    message.monuments.push(
                        AppMap_Monument.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.monuments.length; i++)
            AppMap_Monument.internalBinaryWrite(
                message.monuments[i],
                writer.tag(5, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppEntityInfo$Type extends MessageType<AppEntityInfo> {
        ...
        super("rustplus.AppEntityInfo", [
            {
                ...
                name: "type",
                kind: "enum",
                T: () => ["rustplus.AppEntityType", AppEntityType]
            },
            {
                no: 3,
                name: "payload",
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* rustplus.AppEntityPayload payload */ 3:
                    message.payload = AppEntityPayload.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.payload
    ...
    internalBinaryWrite(
        ...
        if (message.payload)
            AppEntityPayload.internalBinaryWrite(
                message.payload,
...
class AppEntityPayload$Type extends MessageType<AppEntityPayload> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.AppEntityPayload.Item items */ 2:
                    message.items.push(
                        AppEntityPayload_Item.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.items.length; i++)
            AppEntityPayload_Item.internalBinaryWrite(
                message.items[i],
                writer.tag(2, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppEntityPayload_Item$Type extends MessageType<AppEntityPayload_Item> {
    ...
    create(
        value?: PartialMessage<AppEntityPayload_Item>
...
class AppTeamInfo$Type extends MessageType<AppTeamInfo> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.AppTeamInfo.Member members */ 2:
                    message.members.push(
                        AppTeamInfo_Member.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
                ...
                case /* repeated rustplus.AppTeamInfo.Note mapNotes */ 3:
                    message.mapNotes.push(
                        AppTeamInfo_Note.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.members.length; i++)
            AppTeamInfo_Member.internalBinaryWrite(
                message.members[i],
                writer.tag(2, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        for (let i = 0; i < message.mapNotes.length; i++)
            AppTeamInfo_Note.internalBinaryWrite(
                message.mapNotes[i],
                writer.tag(3, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppTeamInfo_Member$Type extends MessageType<AppTeamInfo_Member> {
    ...
    internalBinaryWrite(
        ...
        if (message.name !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.name);
        /* float x = 3; */
        if (message.x !== 0) writer.tag(3, WireType.Bit32).float(message.x);
        /* float y = 4; */
        if (message.y !== 0) writer.tag(4, WireType.Bit32).float(message.y);
        /* bool isOnline = 5; */
        ...
        super("rustplus.AppTeamInfo.Note", [
            {
                ...
                kind: "enum",
                T: () => [
                    "rustplus.AppTeamInfo.Note.Type",
            ...
            { no: 4, name: "y", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            {
                ...
                kind: "enum",
                T: () => [
                    "rustplus.AppTeamInfo.Note.Icon",
            ...
            },
            {
                ...
                kind: "enum",
                T: () => [
                    "rustplus.AppTeamInfo.Note.ColourIndex",
...
class AppTeamChat$Type extends MessageType<AppTeamChat> {
            ...
            switch (fieldNo) {
                case /* repeated rustplus.AppTeamMessage messages */ 1:
                    message.messages.push(
                        AppTeamMessage.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.messages.length; i++)
            AppTeamMessage.internalBinaryWrite(
                message.messages[i],
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join();
...
class AppMarker$Type extends MessageType<AppMarker> {
    constructor() {
        super("rustplus.AppMarker", [
            { no: 1, name: "id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            {
                ...
                name: "type",
                kind: "enum",
                T: () => ["rustplus.AppMarkerType", AppMarkerType]
            },
            { no: 3, name: "x", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 4, name: "y", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional rustplus.Vector4 color1 */ 8:
                    message.color1 = Vector4.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.color1
                ...
                case /* optional rustplus.Vector4 color2 */ 9:
                    message.color2 = Vector4.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.color2
                ...
                case /* repeated rustplus.AppMarker.SellOrder sellOrders */ 13:
                    message.sellOrders.push(
                        AppMarker_SellOrder.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.sellOrders.length; i++)
            AppMarker_SellOrder.internalBinaryWrite(
                message.sellOrders[i],
                writer.tag(13, WireType.LengthDelimited).fork(),
                options
            ).join();
        const u = options.writeUnknownFields;
...
class AppClanChat$Type extends MessageType<AppClanChat> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated rustplus.AppClanMessage messages */ 1:
                    message.messages.push(
                        AppClanMessage.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.messages.length; i++)
            AppClanMessage.internalBinaryWrite(
                message.messages[i],
                writer.tag(1, WireType.LengthDelimited).fork(),
                options
            ).join();
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* rustplus.AppTeamMessage message */ 1:
                    message.message = AppTeamMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.message
...
class AppEntityChanged$Type extends MessageType<AppEntityChanged> {
    ...
    internalBinaryRead(
        ...
        while (reader.pos < end) {
            const [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional uint32 entityId */ 1:
                    message.entityId = reader.uint32();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* rustplus.AppClanMessage message */ 2:
                    message.message = AppClanMessage.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.message
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* rustplus.Vector2 mouseDelta */ 2:
                    message.mouseDelta = Vector2.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.mouseDelta
...
class AppCameraRays$Type extends MessageType<AppCameraRays> {
            ...
            switch (fieldNo) {
                ...
                case /* repeated rustplus.AppCameraRays.Entity entities */ 5:
                    message.entities.push(
                        AppCameraRays_Entity.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options
                        )
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.entities.length; i++)
            AppCameraRays_Entity.internalBinaryWrite(
                message.entities[i],
                writer.tag(5, WireType.LengthDelimited).fork(),
                options
            ).join();
    ...
    constructor() {
        super("rustplus.AppCameraRays.Entity", [
            ...
            },
            {
                ...
                kind: "enum",
                T: () => [
                    "rustplus.AppCameraRays.EntityType",
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* rustplus.Vector3 rotation */ 4:
                    message.rotation = Vector3.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.rotation
                ...
                case /* rustplus.Vector3 size */ 5:
                    message.size = Vector3.internalBinaryRead(
                        reader,
                        reader.uint32(),
                        options,
                        message.size
