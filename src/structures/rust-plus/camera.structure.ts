...
export class Camera extends EventEmitter {
    ...
    constructor(public identifier: string) {
        ...
        container.client.on("message", this.onMessage.bind(this));

        container.client.once("disconnected", this.onDisconnected.bind(this));
    }
    ...
    public async subscribe() {
        ...
        const response = (await container.client.services.camera.subscribe(
            this.identifier
        )) as AppResponse;
    ...
    public async unsubscribe() {
        ...
        container.client.removeListener("message", this.onMessage.bind(this));
        ...
        if (container.client.isConnected) {
            await container.client.services.camera.unsubscribe();
        }
    ...
    public async zoom(): Promise<boolean> {
        ...
        await container.client.services.camera.input(
        ...
        await container.client.services.camera.input(Buttons.NONE, 0, 0);
    ...
    async reload(): Promise<boolean> {
        ...
        /* Press left mouse button to shoot. */
        await container.client.services.camera.input(Buttons.RELOAD, 0, 0);
