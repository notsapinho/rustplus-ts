...
class ClanInfo$Type extends MessageType<ClanInfo> {
    constructor() {
        super("rustplus.ClanInfo", [
            ...
            { no: 10, name: "roles", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClanInfo_Role },
            { no: 11, name: "members", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClanInfo_Member },
            { no: 12, name: "invites", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClanInfo_Invite },
...
class ClanLog$Type extends MessageType<ClanLog> {
    constructor() {
        super("rustplus.ClanLog", [
            { no: 1, name: "clanId", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "logEntries", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClanLog_Entry }
        ]);
    }
...
class ClanInvitations$Type extends MessageType<ClanInvitations> {
    constructor() {
        super("rustplus.ClanInvitations", [
            { no: 1, name: "invitations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClanInvitations_Invitation }
        ]);
    }
...
class AppInfo$Type extends MessageType<AppInfo> {
    constructor() {
        super("rustplus.AppInfo", [
            ...
            { no: 16, name: "camerasEnabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
...
class AppMap$Type extends MessageType<AppMap> {
    constructor() {
        super("rustplus.AppMap", [
            ...
            { no: 5, name: "monuments", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppMap_Monument },
...
class AppEntityPayload$Type extends MessageType<AppEntityPayload> {
    constructor() {
        super("rustplus.AppEntityPayload", [
            { no: 1, name: "value", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "items", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppEntityPayload_Item },
...
class AppTeamInfo$Type extends MessageType<AppTeamInfo> {
    constructor() {
        super("rustplus.AppTeamInfo", [
            ...
            { no: 2, name: "members", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppTeamInfo_Member },
            { no: 3, name: "mapNotes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppTeamInfo_Note },
            { no: 4, name: "leaderMapNotes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppTeamInfo_Note }
        ]);
    }
...
class AppTeamChat$Type extends MessageType<AppTeamChat> {
    constructor() {
        super("rustplus.AppTeamChat", [
            { no: 1, name: "messages", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppTeamMessage }
        ]);
    }
...
class AppMarker$Type extends MessageType<AppMarker> {
    constructor() {
        super("rustplus.AppMarker", [
            ...
            { no: 13, name: "sellOrders", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppMarker_SellOrder }
        ]);
    }
...
class AppMarker_SellOrder$Type extends MessageType<AppMarker_SellOrder> {
    constructor() {
        super("rustplus.AppMarker.SellOrder", [
            ...
            { no: 10, name: "priceMultiplier", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
...
class AppMapMarkers$Type extends MessageType<AppMapMarkers> {
    constructor() {
        super("rustplus.AppMapMarkers", [
            { no: 1, name: "markers", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppMarker }
        ]);
    }
...
class AppClanChat$Type extends MessageType<AppClanChat> {
    constructor() {
        super("rustplus.AppClanChat", [
            { no: 1, name: "messages", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppClanMessage }
        ]);
    }
...
class AppEntityChanged$Type extends MessageType<AppEntityChanged> {
    constructor() {
        super("rustplus.AppEntityChanged", [
            { no: 1, name: "entityId", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ },
...
class AppCameraRays$Type extends MessageType<AppCameraRays> {
    constructor() {
        super("rustplus.AppCameraRays", [
            ...
            { no: 5, name: "entities", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AppCameraRays_Entity },
