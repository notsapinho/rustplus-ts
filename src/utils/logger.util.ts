...
export class Logger {
    ...
    public static info = (...text: string[]): void =>
        console.log(chalk`${Logger.tag} {rgb(66,135,245) ${text.join(" ")}}`);

    public static error = (...text: string[]): void =>
        console.log(chalk`${Logger.tag} {rgb(245,66,66) ${text.join(" ")}}`);

    public static success = (...text: string[]): void =>
        console.log(chalk`${Logger.tag} {rgb(66,245,135) ${text.join(" ")}}`);

    public static warn = (...text: string[]): void =>
        console.log(chalk`${Logger.tag} {rgb(245,221,66) ${text.join(" ")}}`);
